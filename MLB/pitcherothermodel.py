...
# Earned Runs
X = df[[ "line", "opprank","last5",  "inningspitchedlast3",\
          "temperature", "fip"]]
 #Hits Allowed
#X = df[[ "homeaway", "last5", "inningspitchedlast3",\
 #         "temperature", "fip"]]
...
plt.savefig('earnedRuns_correlation_matrix.png')
...
pickle.dump(classifier, open("pitcherothermodel.pkl", "wb"))
